            ...
            <div class="card border-left-primary shadow h-100 py-2 bg-warning">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-user fa-2x text-gray-300" id="mi-icono"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-success shadow h-100 py-2 bg-success">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-users fa-2x text-gray-300" id="mi-icono"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-info shadow h-100 py-2 bg-primary">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-clipboard-list fa-2x text-gray-300" id="mi-icono"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-warning bg-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign fa-2x text-white-300" id="mi-icono"></i>
                        </div>
                    </div>
                </div>
            </div>
